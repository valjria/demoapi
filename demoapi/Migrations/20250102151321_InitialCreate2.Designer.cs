...
namespace demoapi.Migrations
{
    ...
    [Migration("20250102151321_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("demoapi.Models.Course", b =>
                {
                    b.Property<int>("CourseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Grade", b =>
                {
                    b.HasOne("demoapi.Models.Course", "Course")
                        .WithMany("Grades")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("demoapi.Models.Student", "Student")
                        .WithMany("Grades")
